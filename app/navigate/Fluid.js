...
const Fluid = () => {
    ...
    return (
        <>
                ...
                <div className="overlayContent">
                    <div className='flex flex-col max-h-screen no-scrollbar bg-zinc-950' onClick={toggleNav}>
                        ...
                        <div className='overflow-auto lg:overflow-hidden no-scrollbar'>
                            <div className='flex lg:flex-row flex-col border-t-2 divide-x-2 divide-zinc-900 h-screen'>
                                ...
                                <div className='flex flex-col lg:flex-row divide-x-2 lg:w-11/12 divide-zinc-900'>
                                    ...
                                    <div className='flex flex-col lg:space-y-5 space-y-2 px-6 lg:w-8/12 lg:p-14 p-8'>
                                        <p className='text-xs lg:pb-10 tracking-widest font-bold text-zinc-300'>SUBSIDERIES</p>
                                        <ps>Homoeopathy</ps>
                                        <ps>Ayurveda</ps>
                                        <ps>Paramedical</ps>
                        ...
                        {/* Bottom content */}
                        <div className='h-24 w-full lg:flex hidden lg:flex-row flex-col lg:justify-between border-t-2 border-zinc-900 divide-x-2 lg:px-5 divide-zinc-900 text-zinc-300'>
            ...
            <div onClick={toggleNav} className='bg-white p-4 fixed z-[9999] float-right right-0 shadow-2xl shadow-white'>
