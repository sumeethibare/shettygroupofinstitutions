        ...
        <>
            ...
            <div id="myNav" className="overlay no-scrollbar">
                <div className="overlayContent">
                    <div className='flex flex-col max-h-screen no-scrollbar' onClick={toggleNav}>
                        {/* Top content */}
                        ...
                        {/* Bottom content */}
                        <div className='h-24 w-full flex lg:flex-row flex-col lg:justify-between border-t-2 border-zinc-400 divide-x-2 lg:px-5 divide-zinc-400'>
            ...
            <div className='float float-right right-10 top-10 absolute z-50'>
                <button onClick={toggleNav} className="btn btn-ghost btn-circle">
